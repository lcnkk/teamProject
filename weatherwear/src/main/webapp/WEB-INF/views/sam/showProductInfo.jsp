...
<body>
	<div style="padding: 10px 0 10px 0">
		...
		<span><a href="showProductList.jsp">카테고리2</a></span>
	</div>
	<div class="product">
		<div class="image">
		...
		<div class="info" style="width:350px">
			<div style="height:50px; font-size:20px;">막스마라 여자 코트 아이콘 마누엘라 카멜 1016163306001</div>
			...
			<div>
				<div style="padding:50px 0 50px 20px;">
					<a href="#"><input type="button" class="cart" value="장바구니"></a>
					<a href="#"><input type="button" class="order" value="구매하기"></a>
				</div>
			</div>
		</div>
	</div>
