...
<script src="resources/admin/js/bootstrap/bootstrap.min.js"></script>
				...
				<div class="sub-type notice">
					<div class="inner-box">
						<article class="notice-area">
							<div class="menu-nav" style="margin-left:500px;">
								<button type="button" id="newCouponBtn" class="btn-write" onclick="location.href='/w2/newCouponDetail.mdo'">새 쿠폰 받기</button>
							</div>
							<div class="notice-wrap">
								<form id="searchForm" name="searchForm" action="#" method="post">
									...
									<div class="table-type3" id="couponTable" style="position: relative; margin-top: 28px; padding-bottom: 15px; border-bottom: 2px solid #111;">
										...
										<a href="/w2/coupon.mdo"> 
											<button type="button" id="noticeBtn" class="btn-write" style="margin-left:500px;">쿠폰 관리자 페이지로 이동</button> 
										</a>
									</div>
