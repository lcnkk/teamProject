...
<body>
	<div id="container">
		...
		<div class="main_image">
			<img src="resources/image/sunny.gif" width="97.55%"
				height="300" alt="눈">
			<h1 class="main_image_text" style="font-size: 50px">1°C / 7°C</h1>
			<br> <img class="weather_image"
				src="resources/image/sun.png" width="5%" height="45" alt="해">
			<h5 class="main_image_text2" style="font-size: 20px">오늘 맑음</h5>
		</div>
		<!--         <section id="weather"> -->
		...
		<section id="middle">
			<section id="contents">
				...
				<dl>
					...
					<dd>- text-justify : 정렬 시 공백 조정 [ auto | none | inter-word |
						distribute ]</dd>
					<dd>- text-indent : 텍스트 들여쓰기 [ 크기 | 백분율 ]</dd>
					<dd>- line-height : 줄 간격 조정 [ normal | 숫자 | 크기 | 백분율 | inherit
						]</dd>
			...
			<aside id="side">
				...
				- list 속성
				<ul>
					<li>list-style-position : inside<br>목록 들여쓰기
					</li>
				</ul>
				<dl>
					<dd>- background-attachment : [ scroll : 스크롤(기본값) | fixed : 배경
						이미지 고정 ]</dd>
				</dl>
			</aside>
		</section>
